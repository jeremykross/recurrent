(defproject recurrent "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "recurrent.core/on-js-reload"}

                :compiler {:main recurrent.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/recurrent.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/recurrent.js"
                           :main recurrent.core
